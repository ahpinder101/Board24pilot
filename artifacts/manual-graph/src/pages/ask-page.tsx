...
import { Bot, User, Send, BookOpen, Loader2, MessageSquare, ExternalLink, FileText } from "lucide-react";
    ...
    <div className="h-full flex flex-col max-w-4xl mx-auto w-full px-6 py-6">
      ...
      <div className="mb-5 shrink-0">
        ...
        <p className="text-sm text-gray-500 mt-0.5">
          Ask anything about your uploaded manuals. Click any source to open the PDF at the cited page.
        </p>
      </div>
